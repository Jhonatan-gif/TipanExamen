...
namespace TipanProyecto.Controllers
{
    public class PlanRecompensasController : Controller
    {
        ...
        public PlanRecompensasController(TipanProyectoBD context)
        {
            _context = context;
        }
        ...
        {
            var tipanProyectoBD = _context.PlanRecompensas.Include(p => p.Cliente);
            return View(await tipanProyectoBD.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("PlanRecompensasId,Nombre,FechaInicio,PuntosAcumulados,TipoRecompensa,ClienteId")] PlanRecompensas planRecompensas)
        {
            ...
            ViewData["ClienteId"] = new SelectList(_context.Cliente, "ClienteId", "Email", planRecompensas.ClienteId);
            return View(planRecompensas);
        }
